"""
Django settings for frosty_bar_46632 project.
...
ROOT_URLCONF = 'frosty_bar_46632.urls'
...
WSGI_APPLICATION = 'frosty_bar_46632.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_bar_46632 API",
    "DESCRIPTION": "API documentation for frosty_bar_46632 App",
    "VERSION": "v1",
}
